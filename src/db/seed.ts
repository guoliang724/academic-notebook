import { getPool, ensureTables } from './index';
  ...
  try {
    ...
    for (const a of articles) {
      await conn.execute(
        ...
        [a.id, a.title, a.genre, a.body, a.translation, a.insights, a.grammar, a.vocab, a.specialHTML, now, now]
      );
    }
    ...
    for (const t of templates) {
      await conn.execute(
        ...
        [t.id, t.name, t.category, t.content, now, now]
      );
    }
